...
$titulo      = 'Alterar Pokemon';
$nome        = $poke->getNome();
$lvl         = $poke->getLvl();
$regiao      = $poke->getRegiao()->getId(); 
$hp          = $poke->getHp();
$attack      = $poke->getAttack(); 
$defense     = $poke->getDefense();
$spAttack    = $poke->getSpAttack();
$spDefense   = $poke->getSpDefense();
$speed       = $poke->getSpeed();
$sprite      = $poke->getSprite();
$tipo1       = $poke->getTipo1()->getId();
$tipo2       = $poke->getTipo2() ? $poke->getTipo2()->getId() : null;
$erros       = [];
$erroMsg     = "";
...
if($_POST!==[]){
    ...
    $oPokemon = new Pokemon($id,$nome,$lvl,$sprite,$hp,$attack,$defense,$spAttack,$spDefense,$speed,
    $oTipo1,$oTipo2,$oRegiao);

    $erros = PokemonController::update($oPokemon);
